...
private:
    ...
    ssize_t interruptibleRead(int fd, unsigned char *buf, size_t nbyte, std::atomic<bool>& interrupt);
    ssize_t interruptibleWrite(int fd, const unsigned char *buf, size_t nbyte, std::atomic<bool>& interrupt);
